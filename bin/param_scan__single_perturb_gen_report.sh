...
echo "python ${PROJ_DIR}/bin/latex_report_par_scan.py"
python ${PROJ_DIR}/bin/param_scan__single_perturb_report.py $model_noext $specie ${results_dir} ${tc_parameter_scan_dir} ${param_scan__single_perturb_prefix_results_filename} ${tc_parameter_scan_dir} ${param_scan__single_perturb_legend}
