...
def main(args):
  ...
  input_dirs = [ input_dir + '/' + models[0] + '/tc_parameter_scan/', input_dir + '/' + models[1] + '/tc_parameter_scan/', input_dir + '/' + models[2] + '/tc_parameter_scan/' ]
  ...
  compare_model_hypotheses_3hp(output_dir, folders, models, species)
