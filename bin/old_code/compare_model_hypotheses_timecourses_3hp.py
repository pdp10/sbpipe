...
def main(args):
  ...
  input_dirs = [ input_dir + '/' + models[0] + '/tc_mean_with_exp/', input_dir + '/' + models[1] + '/tc_mean_with_exp/', input_dir + '/' + models[2] + '/tc_mean_with_exp/' ]
  folders = [ os.listdir(input_dirs[0]), os.listdir(input_dirs[1]), os.listdir(input_dirs[2])]
  ...
  compare_model_hypotheses_timecourses_3hp(output_dir, folders, models, names_table)
