...
<!-- generated with COPASI 4.16 (Build 104) (http://www.copasi.org) at 2016-07-23 16:42:01 UTC -->
...
<rdf:RDF xmlns:dcterms="http://purl.org/dc/terms/" xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#">
  ...
  <ListOfTasks>
    ...
    <Task key="Task_16" name="Scan" type="scan" scheduled="true" updateModel="false">
      <Report reference="Report_18" target="../tmp/insulin_receptor_k1_scan.csv" append="0" confirmOverwrite="0"/>
      <Problem>
        <Parameter name="Subtask" type="unsignedInteger" value="1"/>
        <ParameterGroup name="ScanItems">
          <ParameterGroup name="ScanItem">
            <Parameter name="Maximum" type="float" value="0.15"/>
            <Parameter name="Minimum" type="float" value="0.06"/>
  ...
  <ListOfReports>
    ...
    <Report key="Report_18" name="Scan Parameters, Time, Concentrations, Volumes, and Global Quantity Values" taskType="scan" separator="&#x09;" precision="6">
      ...
      <Table printTitle="1">
        ...
        <Object cn="CN=Root,Model=Insulin Receptor,Vector=Values[k1],Reference=Value"/>
      </Table>
    </Report>
