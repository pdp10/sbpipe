    ...
    def test_simple_lotka_volterra_simulation(self):
        ...
        try:
            ...
            if "FALSE" in output:
                ...
                self.assertEqual(sbpipe.main(["sbpipe", "--simulate", "simple_lotka_volterra.conf"]), 0)
        except OSError as e:
    ...
    def test_2Dpde_lotka_volterra_simulation(self):
        ...
        try:
            ...
            if "FALSE" in output:
                ...
                self.assertEqual(sbpipe.main(["sbpipe", "--simulate", "2Dpde_lotka_volterra.conf"]), 0)
        except OSError as e:
            print("Skipping test as R was not found.")
    ...
    def test_sde_periodic_drift(self):
        ...
        try:
            ...
            if "FALSE" in output:
                ...
                self.assertEqual(sbpipe.main(["sbpipe", "--simulate", "sde_periodic_drift.conf"]), 0)
        except OSError as e:
            print("Skipping test as R was not found.")
    ...
    def test_sde_cox_ingersoll_ross_process(self):
        ...
        try:
            ...
            if "FALSE" in output:
                ...
                self.assertEqual(sbpipe.main(["sbpipe", "--simulate", "sde_cox_ingersoll_ross_process.conf"]), 0)
        except OSError as e:
            print("Skipping test as R was not found.")
