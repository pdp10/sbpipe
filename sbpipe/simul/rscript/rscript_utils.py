...
# Utilities for changing column names generated by R

import re


def replace_str_rscript_sim_report(report):
    """
    Replace a group of annotation strings from a generated R report files
