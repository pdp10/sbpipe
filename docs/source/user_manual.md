...
```
usage: sbpipe.py [-h] [-q] [--log-level {DEBUG,INFO,WARNING,ERROR,CRITICAL}]
                 [-V] [--license] [--logo] [-c FILE] [-s FILE] [-p FILE]
                 [-d FILE] [-e FILE]
