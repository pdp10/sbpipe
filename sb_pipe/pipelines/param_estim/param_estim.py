...
class ParamEstim(Pipeline):
    ...
    def generate_data(self, model, inputdir, cluster_type, pp_cpus, nfits, outputdir, sim_data_folder, updated_models_folder):
    ...
    def analyse_data(self, model, inputdir, outputdir, fileout_final_estims, fileout_all_estims, fileout_approx_ple_stats, fileout_conf_levels, sim_plots_folder, best_fits_percent, data_point_num, plot_2d_66_95cl_corr=False, logspace=True):
