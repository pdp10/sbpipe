...
class SingleParamScan(Pipeline):
	...
	logger.info("##############")
	self.analyse_data(model[:-4], scanned_par, single_param_scan_knock_down_only, outputdir, 
	...
	logger.info("##################")
	self.generate_report(model[:-4], scanned_par, outputdir, sim_plots_folder)
    ...
    def generate_data(self, model, variable, sim_number, simulate_intervals, 
    ...
    # levels_number
    # homogeneous_lines
    def analyse_data(self, model, scanned_par, knock_down_only, outputdir, 
			sim_data_folder, sim_plots_folder, simulate__xaxis_label, 
			simulations_number, 
    ...
    def generate_report(self, model_noext, species, outputdir, sim_plots_folder): 
