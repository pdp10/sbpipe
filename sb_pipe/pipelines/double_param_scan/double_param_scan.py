...
def fun_generate_data(model, sim_length, inputdir, outputdir):
...
# inputdir
# outputdir
def fun_analyse_data(model, scanned_par1, scanned_par2, inputdir, outputdir):
...
def fun_generate_report(model_noext, scanned_par1, scanned_par2, outputdir, sim_plots_folder): 
