...
def get_latex_header(pdftitle="SB pipe report", title="SB pipe report", abstract="Generic report."):
    return (
        ...
        "\\usepackage{graphicx}\n"
        "\\usepackage[plainpages=false,pdfauthor={Generated by SB pipe},pdftitle={" + pdftitle + "},pdftex]{hyperref}\n"
        "\\author{Generated by SB pipe} \n"
        "\\title{" + title + "}\n"
        "\\date{\\today}\n"
        "\\begin{document}\n"
        "\\maketitle\n"
...
def latex_report_double_param_scan(outputdir, sim_plots_folder, filename_prefix, model_noext,
    ...
    with open(os.path.join(outputdir, filename_prefix + model_noext + ".tex"), "w") as file_out:
        ...
        header = get_latex_header("Report: " + model_ver,
                                  "Report: " + model_ver,
                                  "Report for the model {\\it " + model_ver + "}, scanning {\\it " +
